...
[**Mac App Store**](https://apps.apple.com/app/id6806579257) or [**download MemoryString 0.9.21 for Mac**](https://github.com/zackypick/memorystring-downloads/releases/download/v0.9.21/MemoryString-0.9.21.dmg) — free, always the latest build. macOS 14 (Sonoma) or later, Apple Silicon and Intel. The App Store build is sandboxed; the direct download is the same app without that sandbox.
