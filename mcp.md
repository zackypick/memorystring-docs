...
- **captions** / **intro** (including Studio **lens** on the opening card) / **timing** (includes **auto_trim** — best-effort Energy-length highlight window, not guaranteed; same as context-menu **Auto Trim**, no confirm; not on import; undo with **document** `undo`) / **audio** / **output**
