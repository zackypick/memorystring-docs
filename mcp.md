...
- **captions** / **intro** (including Studio **lens** on the opening card) / **timing** (includes **auto_trim** — middle 4s plus up to 1s toward a face; stills / short Live Photos skipped; same as context-menu **Auto Trim**, about 70% right, no confirm; not on import; undo with **document** `undo`) / **audio** / **output**
