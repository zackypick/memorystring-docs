...
Stuck mid-edit? The answers live in the app — **Help → MemoryString Help…** (**⌘/** or the **?** toolbar button). **Esc** or **⌘W** closes Help when that window is front. **Help → Full Documentation Online** opens this GitBook in a browser. This site is the same topics, public and searchable.
